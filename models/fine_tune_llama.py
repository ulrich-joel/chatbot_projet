...
# Nom du modèle Hugging Face (pas en local, téléchargé directement)
...
model = AutoModelForCausalLM.from_pretrained(
    ...
    trust_remote_code=True  # Nécessaire pour certains modèles avec un code spécifique
)
...
lora_config = LoraConfig(
    ...
    target_modules=["query_key_value", "dense_h_to_4h"],  # Modules spécifiques à GPT-NeoX
...
if __name__ == "__main__":
    ...
    model.save_pretrained("./fine_tuned_gpt_neox")
    tokenizer.save_pretrained("./fine_tuned_gpt_neox")
    print("Modèle fine-tuné sauvegardé dans ./fine_tuned_gpt_neox")
